...
//  Credit to theagentd from javagaming forums...
...
public class GPUProfiler {
	...
	static {
		...
		queryObjects = new ArrayList <Integer> ();
		frameCounter = 0;
		completedFrames = new ArrayList <GPUTaskProfile> ();
	}
	...
	public static void startFrame() {
		...
		if (PROFILING_ENABLED) {
		  final String label = "Frame "+(++frameCounter);
		  currentTask = taskPool.obtain().init(null, label, getQuery());
		}
	}
	...
	public static void endFrame() {
		if (PROFILING_ENABLED) {
			if (currentTask.getParent() != null) throw new IllegalStateException(
